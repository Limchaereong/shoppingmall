        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="/recentlyView.do" class="nav-link px-2 text-white">최근본상품</a></li>
                    <c:choose>
                        <c:when test="${sessionScope.user ne null}">
                            <li><a href="/cart/cart.do" class="nav-link px-2 text-white">장바구니</a></li>
                        </c:when>
                        <c:otherwise>
                            <!-- 로그인이 되어 있지 않을 때는 장바구니 링크를 표시하지 않습니다 -->
                        </c:otherwise>
                    </c:choose>
                </ul>
