...
public class DbUtils {
    ...
    static {
        ...
        basicDataSource.setUrl("jdbc:mysql://133.186.241.167:3306/nhn_academy_36");
        basicDataSource.setUsername("nhn_academy_36");
        basicDataSource.setPassword("LE./7B[CZtN1T0SA");
